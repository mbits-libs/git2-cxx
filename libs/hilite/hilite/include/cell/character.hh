...
namespace cell {
	...
	public:
		...
		constexpr one_of_characters(std::string_view sv) noexcept
		    : value_{std::move(sv)} {}
	...
	public:
		...
		constexpr literal_character operator()(
		    const char (&c)[2]) const noexcept {
			return c[0];
		}

		template <size_t Length>
		constexpr one_of_characters operator()(
		    const char (&view)[Length]) const noexcept {
