...
namespace cov {
	struct version {
		static constexpr char string[] =
		    "@PROJECT_VERSION_MAJOR@.@PROJECT_VERSION_MINOR@.@PROJECT_VERSION_"
		    "PATCH@";
		static constexpr char string_short[] =
		    "@PROJECT_VERSION_MAJOR@.@PROJECT_VERSION_MINOR@";
		static constexpr char stability[] =
		    "@PROJECT_VERSION_STABILITY@";  // or "-alpha.5", "-beta", "-rc.3",
		                                    // "", ...
		static constexpr char build_meta[] = "@PROJECT_VERSION_BUILD_META@";
		static constexpr char ui[] =
		    "@PROJECT_VERSION@@PROJECT_VERSION_STABILITY@@PROJECT_VERSION_"
		    "BUILD_META@";
