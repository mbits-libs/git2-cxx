...
#define MAKE_COLOR_TEST(NAME, COLOR) MAKE_TEST(NAME, "%" NAME, COLOR)
	...
	static parser_test const tests[] = {
	    ...
	    MAKE_COLOR_TEST("C(rating)", ph::color::rating_lines),
	    MAKE_COLOR_TEST("C(bold rating)", ph::color::bold_rating_lines),
	    MAKE_COLOR_TEST("C(bg rating)", ph::color::bg_rating_lines),
	    MAKE_COLOR_TEST("C(faint rating)", ph::color::faint_rating_lines),
	    MAKE_COLOR_TEST("C(rating:L)", ph::color::rating_lines),
	    MAKE_COLOR_TEST("C(bold rating:L)", ph::color::bold_rating_lines),
	    MAKE_COLOR_TEST("C(bg rating:L)", ph::color::bg_rating_lines),
	    MAKE_COLOR_TEST("C(faint rating:L)", ph::color::faint_rating_lines),
	    MAKE_COLOR_TEST("C(rating:F)", ph::color::rating_functions),
	    MAKE_COLOR_TEST("C(bold rating:F)", ph::color::bold_rating_functions),
	    MAKE_COLOR_TEST("C(bg rating:F)", ph::color::bg_rating_functions),
	    MAKE_COLOR_TEST("C(faint rating:F)", ph::color::faint_rating_functions),
	    MAKE_COLOR_TEST("C(rating:B)", ph::color::rating_branches),
	    MAKE_COLOR_TEST("C(bold rating:B)", ph::color::bold_rating_branches),
	    MAKE_COLOR_TEST("C(bg rating:B)", ph::color::bg_rating_branches),
	    MAKE_COLOR_TEST("C(faint rating:B)", ph::color::faint_rating_branches),
