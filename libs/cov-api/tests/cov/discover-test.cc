...
namespace cov::testing {
	...
	static discover_test const tests[] = {
	    ...
	    {
	        "inside_git_worktree"sv,
	        "worktree/subdir"sv,
	        {},
	        make_setup(
	            remove_all("discover"sv),
	            remove_all("worktree"sv),
	            create_directories("discover/.git/objects/pack"sv),
	            create_directories("discover/.git/objects/info"sv),
	            create_directories("discover/.git/refs/tags"sv),
	            create_directories("discover/.git/worktrees/worktree"sv),
	            create_directories("worktree/subdir"sv),
	            touch("discover/.git/HEAD"sv),
	            touch("discover/.git/config"sv),
	            touch("discover/.git/refs/heads/main"sv),
	            touch("discover/.git/worktrees/worktree/HEAD"sv),
	            touch("discover/.git/worktrees/worktree/ORIG_HEAD"sv),
	            touch("discover/.git/worktrees/worktree/commondir"sv,
	                  "../..\n"sv),
	            touch("discover/.git/worktrees/worktree/gitdir"sv),
	            touch("worktree/.git"sv,
	                  "gitdir: ../discover/.git/worktrees/worktree\n"sv),
	            init_repo("discover/.git/.covdata"sv, "discover/.git/"sv)),
	    },
	    {
	        "inside_cov_worktree"sv,
	        "worktree/subdir"sv,
	        "discover/.git/.covdata/worktrees/worktree"sv,
	        make_setup(
	            remove_all("discover"sv),
	            remove_all("worktree"sv),
	            create_directories("discover/.git/objects/pack"sv),
	            ...
	            touch("discover/.git/worktrees/worktree/commondir"sv,
	                  "../..\n"sv),
	            touch("discover/.git/worktrees/worktree/gitdir"sv),
	            touch("discover/.git/worktrees/worktree/.covdata"sv,
	                  "covdata: ../../.covdata/worktrees/worktree\n"sv),
	            touch("worktree/.git"sv,
	                  "gitdir: ../discover/.git/worktrees/worktree\n"sv),
	            init_repo("discover/.git/.covdata"sv, "discover/.git/"sv),
	            touch("discover/.git/.covdata/worktrees/worktree/HEAD"sv),
	            touch("discover/.git/.covdata/worktrees/worktree/commondir"sv,
	                  "../..\n"sv),
	            touch("discover/.git/.covdata/worktrees/worktree/gitdir"sv,
	                  "../../../worktrees/worktree\n"sv)),
	    },
	    {
	        "is_valid_path"sv,
