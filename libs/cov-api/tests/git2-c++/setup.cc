	...
	namespace {
		namespace file {
			...
			static constexpr auto text_2 =
			    "first line\r\n"
			    "second line\r\n"sv;
			static constexpr auto text_3 = "ref: refs/heads/main\n"sv;
			...
			static constexpr auto text_7 = "../../../../worktree/.git\n"sv;
			static constexpr auto text_8 = "ref: refs/heads/secondary\n"sv;
			static constexpr auto text_9 = ""sv;
			...
			static constexpr auto text_12 = "ref: refs/remotes/origin/main\n"sv;
			static constexpr auto text_13 =
			    "b3f67d63bd1c87427805eba4aa028bfa43587f78\n"sv;
			static constexpr auto text_14 =
			    "# Testing repos\n"
			    "\n"
			    "Change from this commit\n"sv;
			static constexpr auto text_15 = "gitdir: ../.git/modules/bare\n"sv;
			static constexpr auto text_16 =
			    "gitdir: ../gitdir/.git/worktrees/worktree\n"sv;
			static constexpr auto text_17 = "this file is untracked\n"sv;
			static constexpr auto text_18 =
			    "[core]\n"
			    "       repositoryformatversion = 0\n"
			    "       filemode = false\n"
			    "       bare = true\n"
			...
			static constexpr unsigned char binary_2[] = {
			    ,
			    ...
			    0x64, 0x69, 0x72, 0x00, 0x31, 0x20, 0x30, 0x0a, 0x56, 0x18,
			    0xe1, 0x71, 0x82, 0xd4, 0x90, 0x46, 0x37, 0x31, 0xfa, 0x55,
			    0xd3, 0xc9, 0x35, 0x18, 0xae, 0x7b, 0xc2, 0x27, 0x56, 0x44,
			    0xe0, 0x80, 0x2e, 0xac, 0xb4, 0x60, 0x9c, 0x5f, 0x6f, 0x29,
			    0x61, 0xd0, 0x26, 0x45, 0xd3, 0x78, 0x75, 0xcc};
		...
		constexpr std::string_view subdirs[] = {
		    "gitdir/.git/worktrees/worktree/modules"sv,
		...
		constexpr file::text text[] = {
		    {"bare.git/HEAD"sv, file::text_3},
		    {"bare.git/config"sv, file::text_18},
		    {"bare.git/refs/heads/main"sv, file::text_13},
		    {"gitdir/.git/HEAD"sv, file::text_3},
		    {"gitdir/.git/config"sv, file::text_4},
		    {"gitdir/.git/modules/bare/FETCH_HEAD"sv, file::text_9},
		    {"gitdir/.git/modules/bare/HEAD"sv, file::text_3},
		    {"gitdir/.git/modules/bare/config"sv, file::text_11},
		    {"gitdir/.git/modules/bare/packed-refs"sv, file::text_10},
		    {"gitdir/.git/modules/bare/refs/heads/main"sv, file::text_13},
		    {"gitdir/.git/modules/bare/refs/remotes/origin/HEAD"sv,
		     file::text_12},
		    {"gitdir/.git/modules/bare/refs/remotes/origin/main"sv,
		     file::text_13},
		    {"gitdir/.git/refs/heads/main"sv, file::text_6},
		    {"gitdir/.git/refs/heads/secondary"sv, file::text_6},
		    {"gitdir/.git/worktrees/worktree/HEAD"sv, file::text_8},
		    {"gitdir/.git/worktrees/worktree/ORIG_HEAD"sv, file::text_6},
		    {"gitdir/.git/worktrees/worktree/commondir"sv, file::text_5},
		    {"gitdir/.git/worktrees/worktree/gitdir"sv, file::text_7},
		    {"gitdir/.gitmodules"sv, file::text_1},
		    {"gitdir/bare/.git"sv, file::text_15},
		    {"gitdir/bare/README.md"sv, file::text_14},
		    {"gitdir/subdir/a-file"sv, file::text_2},
		    {"worktree/.git"sv, file::text_16},
		    {"worktree/.gitmodules"sv, file::text_1},
		    {"worktree/subdir/a-file"sv, file::text_2},
		    {"worktree/subdir/untracked"sv, file::text_17},
		};
		...
		constexpr file::binary binary[] = {
		    ...
		    {"bare.git/objects/ed/631389fc343f7788bf414c2b3e77749a15deb6"sv,
		     span(file::binary_21)},
		    {"gitdir/.git/index"sv, span(file::binary_1)},
		    ...
		    {"gitdir/.git/objects/bc/a9d5f2a50092f1ad2f52d03bded3bd9d2b5edd"sv,
		     span(file::binary_8)},
		    {"gitdir/.git/worktrees/worktree/index"sv, span(file::binary_2)},
		};
	}  // namespace
