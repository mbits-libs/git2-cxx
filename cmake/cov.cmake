...
macro(add_cov_ext COV_TOOL)
  ...
  elseif(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${__COV_TOOL_SAFE_NAME}/main.cc)
    set(${COV_TOOL}_CODE ${__COV_TOOL_SAFE_NAME}/main.cc)
  elseif(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${__COV_TOOL_SAFE_NAME}/${__COV_TOOL_SAFE_NAME}.cc)
    set(${COV_TOOL}_CODE ${__COV_TOOL_SAFE_NAME}/${__COV_TOOL_SAFE_NAME}.cc)
  else()
